...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1 class="jumbotron-heading">Get Start</h1>
    </div>
  </section>
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <p>ก่อนที่จะได้ API นั้นเราต้องเป็น Twitter Deverloper ก่อน</p>
        <p>สามารถดูรายละเอียดเพิ่มเติมได้ที่ <a href="https://developer.twitter.com/en/docs/basics/getting-started">https://developer.twitter.com/en/docs/basics/getting-started</a><p>
        <hr>
