...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1 class="jumbotron-heading">Soure code</h1>
    </div>
  </section>
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <nav class="blog-pagination">
        <a class="btn btn-outline-secondary" href="plugin.php">back</a>
        <a class="btn btn-outline-primary" href="contact.php">Next</a>
      </nav>
